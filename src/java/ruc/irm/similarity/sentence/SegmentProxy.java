...
public class SegmentProxy {
	...
	public static List<Word> segment(String sentence){
		...
		List<Term> segre=HanLP.segment(sentence);
		for(Term a: segre){
			    String b =a.toString();
//				Pattern expressionproperty = Pattern.compile("/[a-zA-Z]+.?");
//				Matcher matcherproperty = expressionproperty.matcher(b);
//				
//			    while (matcherproperty.find()){
//					   b= matcherproperty.replaceAll("");
//			    }
				Word wd=new Word(b,1);
				results.add(wd);
//				System.out.print(a+" ");
				System.out.print(b+" ");
